        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" rows="7" name="description" required>{{ $project->description }}</textarea>
            ...
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="project_url" name="project_url" value="{{ $project->project_url }}" required>
